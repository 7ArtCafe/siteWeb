        ...
        <nav class="navBar">
          <div className="navBar-text-gauche w3-half w3-hide-small">
            ...
            <Link to="/carte/produits">
              <p class="w3-button w3-hover-none w3-hover-text-orange-7art w3--small">Notre Carte</p>
            </Link>

            <Link to="/shows">
              <p class="w3-button w3-hover-none w3-hover-text-orange-7art w3--small">Divertissements</p>
            </Link>
        ...
        <span className="navBar-text-droite w3-half w3-hide-small">
          ...
          <div className="w3-col l6 m6">
            ...
            <Link to="/a_propos/presentation" className="w3-hide-medium">
              <button class="w3-button w3-hover-none w3-hover-text-orange-7art">A propos de Nous</button>
            </Link>
          ...
          <div class="w3-dropdown-hover w3-col m2 w3-hide-small w3-hide-large">
            <p class="w3-button w3-hover-none w3-hover-text-orange-7art w3--small">A propos</p>
              <div class="w3-dropdown-content w3-bar-block w3-card-4">
                <Link to="/a_propos/presentation">
                  <button class="w3-bar-item w3-white w3-button">De Nous</button>
                </Link>
        ...
        <div className="w3-hide-medium w3-hide-large">
          ...
          >
            <Link to="/" onClick={() => this.closeMenu()} >
              <p className="menu-item">Accueil</p>
            </Link>
            <Link to="/shows" onClick={() => this.closeMenu()}>
              <p className="menu-item">Divertissements</p>
            </Link>
            <Link to="/carte/produits" onClick={() => this.closeMenu()}>
              <p className="menu-item">Nos Produits</p>
            </Link>
            <Link to="/a_propos/presentation" onClick={() => this.closeMenu()}>
              <p className="menu-item">A propos de nous</p>
            </Link>
